...
int sendMessage(int fd, json_object *chat_room_list, const char *char_room_id,const char *from, const char* message, json_object *response);
...
int getRooms(const int fd, json_object *chat_room_list, const int user_id, json_object *response);
